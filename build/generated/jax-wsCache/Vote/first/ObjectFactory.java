...
public class ObjectFactory {
    ...
    private final static QName _Vote_QNAME = new QName("http://First/", "vote");
    private final static QName _VoteResponse_QNAME = new QName("http://First/", "voteResponse");
    ...
    /**
     * Create an instance of {@link Vote_Type }
     * 
     */
    public Vote_Type createVote_Type() {
        return new Vote_Type();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link Vote_Type }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://First/", name = "vote")
    public JAXBElement<Vote_Type> createVote(Vote_Type value) {
        return new JAXBElement<Vote_Type>(_Vote_QNAME, Vote_Type.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://First/", name = "voteResponse")
